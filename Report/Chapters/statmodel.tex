...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-hw.png} \label{fig:italy-hw}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-hwy.png} \label{fig:italy-hwy}
\endminipage
...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-hw.png} \label{fig:usa-hw}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-hwy.png} \label{fig:usa-hwy}
\endminipage
...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-arima.png} \label{fig:italy-arima}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-arimay.png} \label{fig:italy-arimay}
\endminipage
...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-arima.png} \label{fig:usa-arima}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-arimay.png} \label{fig:usa-arimay}
\endminipage
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{NeuralNetNoHidden.png}
\caption{A linear regression model, or ARIMA$(p,0,0)$ model.}
\end{figure}

\begin{figure}
\includegraphics[width=0.9\textwidth]{NeuralNet.png}
...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-nn.png} \label{fig:italy-nn}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Italy-nny.png} \label{fig:italy-nny}
\endminipage
...
\begin{figure}[H]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-nn.png} \label{fig:usa-nn}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{United States-nny.png} \label{fig:usa-nny}
\endminipage
